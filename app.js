(() => {
  "use strict";
function srcLabel(u) { try { const url = new URL(u); return url.protocol === "file:" ? "本地资料文件（需在原电脑打开）" : url.hostname; } catch (e) { return ""; } }
